...
export default function OnboardingStartPage() {
  ...
  return (
    <>
      ...
      {/* Floating Bottom Bar - outside animated div so fixed positioning works */}
      <div className="fixed bottom-0 left-0 right-0 w-full bg-white border-t border-zinc-200 z-40">
