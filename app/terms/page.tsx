...
import { FileText, Mail, Globe, Shield, Clock, User, Lock, Sparkles, ArrowLeft } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
        <MotionStack space={8} className="text-center" stagger={stagger.normal} direction="up">
          ...
          <MotionBox variant="slide-up">
            <Display size="2xl" weight="extrabold">Terms of Service</Display>
          </MotionBox>
          <MotionBox variant="slide-up">
            <Text size="lg" color="muted">Last updated: July 2025</Text>
          </MotionBox>
        </MotionStack>
