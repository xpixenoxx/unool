  ...
  return (
    <div
      ...
      style={{
        ...
        '--profile-radius': '8px',
        '--profile-shadow': '0 4px 12px 0 oklch(0.12 0.02 247.8 / 0.12), 0 2px 6px -2px oklch(0.12 0.02 247.8 / 0.12)',
      } as React.CSSProperties}
    >
      <Stack space={8} className="max-w-[640px] mx-auto px-4 py-12" style={{ fontFamily: 'var(--font-geist)' }}>
        {/* Bold accent bar at top */}
        <div className="w-full h-1 rounded-t" style={{ background: accent }} aria-hidden="true" />

        <Stack space={4} align="center" className="text-center pt-4">
        ...
        {profile.bio && (
          <Card variant="outlined" padding="lg" style={{ borderColor: accent, maxWidth: '640px' }}>
            <CardContent>
