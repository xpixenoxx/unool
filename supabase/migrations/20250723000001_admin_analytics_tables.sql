...
DROP POLICY IF EXISTS "Workspace members can view analytics" ON analytics_events;
...
COMMENT ON COLUMN admin_users.permissions IS 'Granular permissions: users, workspaces, billing, analytics, impersonate';
